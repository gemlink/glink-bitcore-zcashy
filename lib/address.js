...
Address._classifyFromVersion = function(buffer, name) {
  ...
  var pubkeyhashNetwork = Networks.get(prefix, ['pubkeyhash', name]);
  var scripthashNetwork = Networks.get(prefix, ['scripthash', name]);
...
Address._transformBuffer = function(buffer, network, type) {
  ...
  var bufferVersion = Address._classifyFromVersion(buffer, network ? network.name: undefined);
